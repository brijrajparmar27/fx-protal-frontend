...
const ColumnsDetails = [
  ...
  { name: "Country", dataType: "string", key: "countryCode", sort: true },
  { name: "Address", dataType: "string", key: "address", sort: true },
  { name: "Post Code", dataType: "string", key: "postalCode", sort: true }
];
const Columns = [
  "Date",
  "First Name",
...
class SignupClientsReport extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = () => {
    this.getSignupClientsReport();
  };

  getSignupClientsReport = async () => {
    let fromDate = "";
    let toDate = "";
    let queryParam = "";
    // Check for Filter
    ...
    const res = await apiHandler({
      url: endpoint.ADMIN_SIGNUP + queryParam,
    ...
    if (res.data.errorCode) {
      ...
      this.setState({
        apiData: res.data && res.data.users ? res.data.users : [],
        columnSortKey: ""
      });
...
SignupClientsReport.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withRouter(withStyles(styles)(SignupClientsReport));
