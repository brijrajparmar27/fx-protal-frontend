...
class FxForwardReport extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleStatus = async (activityId, event) => {
    ...
    // ADMIN_ACTIVITY_DETAIL_TRADE
    const res = await apiHandler({
      url: endpoint.ADMIN_ACTIVITY_DETAIL_TRADE + activityId,
  ...
  getFxForwardReport = async () => {
    ...
    //ADMIN_TRADE_FIND
    const res = await apiHandler({
      url: endpoint.ADMIN_TRADE_FIND + "?type=FXFWD" + queryParam,
      authToken: sessionStorage.getItem("token")
    });
  ...
  handleTableRowClick = async selectedID => {
    ...
    //    DEAL
    const res = await apiHandler({
      url: endpoint.DEAL + "?type=FXFWD&dealId=" + selectedID,
      authToken: sessionStorage.getItem("token")
    });
...
FxForwardReport.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withRouter(withStyles(styles)(FxForwardReport));
