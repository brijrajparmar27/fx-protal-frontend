...
const PlanSubscriptionModal = ({ showModal, closeModal, details, riskStatus}) => {
            ...
            <GridItem xs={12} sm={12} md={12} lg={12}>
              ...
              <GridContainer>
                ...
                <GridItem xs={8} sm={8} md={8} lg={8}>
                  <GridContainer style={{ marginTop: 20 }}>
                      ...
                      <GridContainer>
                        ...
                        <GridItem xs={12} sm={12} md={12} lg={12} style={{ textAlign: 'start' }}>
                          <div style={{ marginLeft: 28 }}>
                            {' '}
                            {'Please share your Credit Card information which can be used to deduct subscription money'} {!riskStatus.freePlanUsed && ' from next month.'}{' '}
                          </div>
                        </GridItem>                        
                      </GridContainer>
                    </GridItem>
                    ...
                    <GridItem xs={12} sm={12} md={12} lg={12}>
                      <CapturePaymentDetails handleChange={handleChange} change={change} cardChecked={cardChecked} />
                    </GridItem>
                    <GridItem xs={12} sm={12} md={12} lg={12} style={{marginTop: 15, textAlign: 'left'}}>
                      <FormControlLabel
                        ...
                        label={
                          <div className={classes.termsText} style={{fontWeight: 'bold', color: 'black'}}>
                           I do not want to provide card details for the trial
                          </div>
                        }
                      />
                    </GridItem>
              ...
              <GridContainer style={{ marginTop: 28 }}>
                ...
                >
                  {cardChecked ? (
                    <>
                    <div style={{ marginTop: 10 }}>{'-Your plans begins today and will expire on ' + formatDate(nextPlanDate)}</div>
                  ...
                  <div style={{ marginTop: 10 }}>
                    ...
                    before the renewal date on Manage Account.
                  </div>
                  <div style={{ marginTop: 10 }}> -You can cancel or upgrade your plan anytime by going to Manage Plan.</div>
                    </>
                  )}
                </GridItem>
              </GridContainer>
                ...
                <GridItem xs={12} sm={12} md={12} lg={12}>
                  <GridContainer spacing={1} style={{ textAlign: 'center', marginTop: 20 }}>
                    <GridItem className={classes.customText} xs={12} sm={12} md={12} lg={12}>
                      ...
                      />
                      <div style={{fontSize: "xx-small"}}>* Please click to read before you can accept the Terms and conditions</div>
                    </GridItem>
                  </GridContainer>
                </GridItem>
              </GridContainer>
