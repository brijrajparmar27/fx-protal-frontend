...
import dummydata from "views/Pages/json/currencypairalert.json";
...
class CurrencyPairAlert extends React.Component {
  error = {
            ...
            <GridContainer>
              ...
              <GridItem xs={5} sm={5} md={5} lg={5} style={{ float: "right" }}>
                <Button
                  ...
                  color="info"
                  size="md"
                  onClick={() => this.showExistingAlerts()}
                >
                  Manage my alerts
                </Button>
              </GridItem>
...
{/* <span onClick={()=>this.showExistingAlerts()} style={{cursor:'pointer'}}><b>{'Manage my alerts'}</b></span> */}
    ...
    return (
      <>
        <Dialog
          ...
          keepMounted
          onClose={() => this.props.handleClose("showCurrencyPairAlertModal")}
        ...
        >
          ...
          >
            <IconButton
              ...
              onClick={() =>
                this.props.handleClose("showCurrencyPairAlertModal")
              }
            >
              <CloseIcon />
            </IconButton>
...
CurrencyPairAlert.propTypes = {
  classes: PropTypes.object.isRequired
};
export default withStyles(style)(CurrencyPairAlert);
