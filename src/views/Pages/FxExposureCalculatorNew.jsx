          ...
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={12} lg={12}>
              <GridContainer>
                ...
                <GridContainer justify="center">
                  <GridItem xs={12} sm={8} lg={7}>
                    <Card className={cx(classes.exposureCard)}>
                      <CardBody>
                        <h5>
                          <b>Let's put comprehensive title</b>
                        </h5>
                          ...
                          <GridContainer justify="center">
                            <GridItem xs={12} sm={12} md={5} lg={5}>
                              <FormLabel className={cx(classes.currencyLabel)}>
                                ...
                                <a
                                  style={{ marginLeft: "68px", fontSize: 10 }}
                                  href=""
                                  target="_blank"
                                >
                                  Break Currencies
                              ...
                              {this.state.foreignSales &&
                                this.state.foreignSales[0] &&
                                this.state.foreignSales[0].fcsSalesAmount !==
                                  "" && (
                                  <GridContainer>
                                    {this.state.foreignSales &&
                                      this.state.foreignSales.map((obj) => (
                                        <GridItem>
                                          <Chip
                                            label={
                                              obj.fcsSalesAmount +
                                              " " +
                                              obj.fcsSalesCurrency
                                            }
                                            variant="outlined"
                                          />
                                        </GridItem>
                            ...
                            <GridItem xs={12} sm={12} md={5} lg={5}>
                              ...
                              {this.state.foreignCosts &&
                                this.state.foreignCosts[0] &&
                                this.state.foreignCosts[0].fcsCostsAmount !==
                                  "" && (
                                  <GridContainer>
                                    {this.state.foreignCosts &&
                                      this.state.foreignCosts.map((obj) => (
                                        <GridItem>
                                          <Chip
                                            label={
                                              obj.fcsCostsAmount +
                                              " " +
                                              obj.fcsCostsCurrency
                                            }
                                            variant="outlined"
                                          />
                                        </GridItem>
                            ...
                            <GridItem xs={1} sm={1} md={1} lg={1}>
                              ...
                              >
                                ...
                                <DialogContent
                                  ...
                                  className={cx(
                                    classes.modalBody,
                                    classes.loginMaxWidth
                                  )}
                                >
                                  <GridItem xs={12} sm={12} md={12} lg={12}>
                                    <FormLabel className={cx(classes.footer)}>
                                      (included in Total Sales / Cost of Sales
                                      above)
                                    </FormLabel>
                                  </GridItem>
                                  {this.state.foreignSales &&
                                    this.state.foreignSales.map(
                                      (fcsSales, index) => {
                                        return (
                                              ...
                                              >
                                                ...
                                                >
                                                  <Select
                                                    ...
                                                    onChange={this.handleFCSCurrency(
                                                      index
                                                    )}
                                                    inputProps={{
                                              ...
                                              >
                                                ...
                                                >
                                                  <Select
                                                    ...
                                                    onChange={this.handleFCCCurrency(
                                                      index
                                                    )}
                                                    inputProps={{
                            ...
                            <GridContainer>
                              ...
                              {this.state.callInProgress ? (
                                <Dialog
                                  classes={{
                                    root:
                                      classes.center + " " + classes.modalRoot,
                                    paper: classes.modal,
                                  }}
                                  ...
                                  <React.Fragment>
                                    ...
                                    >
                                      <div style={{ fontSize: "x-small" }}>
                                        Or clear options and start over
                                      </div>
                                    </a>
                                  </React.Fragment>{" "}
                                </GridItem>
                                  ...
                                  this.state.grossMarginData.length ? (
                                    <FXExposureCalculatorPrint
                                      ...
                                      hedgingCostPercentage={
                                        this.state.hedgingCostPercentage
                                      }
            ...
            <GridContainer>
              <GridItem xs={0} sm={0} lg={9} />
              {this.state.grossMarginData &&
              this.state.grossMarginData.length ? (
                <GridItem xs={2} sm={2} lg={2} style={{ textAlign: "center" }}>
                  <ReactToPrint
                    trigger={() => (
                      <Button
                        size="lg"
                      ...
                      <GridContainer>
                        ...
                        <GridItem xs={12} sm={12} md={3} lg={3}>
                          ...
                          <CardHeader color="success">
                            <h5>
                              <b>
                                Impact of the FX Movement Compared - With
                                Hedging & No Hedging
                              </b>
                            </h5>
                          </CardHeader>
                        ...
                        <GridItem xs={12} sm={12} md={2} lg={2}>
                          ...
                          >
                            <div>Hedge%</div>
                            <div>{this.state.hedgingPercentage}%</div>
                          </div>
                          <div
                            style={{
                              display: "flex",
                          ...
                          >
                            ...
                            <div>{this.state.impactGrossMargin}% </div>
                          </div>
                          ...
                          >
                            <div>Hedging costs</div>
                            <div>{this.state.hedgingCostPercentage}%</div>
                          </div>
                          ...
                          <ul style={{ fontSize: 10 }}>
                            <li>
                              Correlation between currencies not taken into
                              account{" "}
                            </li>

                            <li>
                              Timing of Foreign currency inflows and outflows
                              not considered{" "}
                            </li>

                            <li>
                              Economic and Translation FX Risks are not covered
                              in this calculator
                            </li>
                          ...
                          this.state.grossMarginData.length ? (
                            <>
                              <CardHeader color="success">
                                <h5>
                                  <b>
                                    Gross Margin (%) when the Currency pairs
                                    move by
                                  </b>
                                </h5>
                              </CardHeader>
                              <CardBody>
                                <Table
                                  ...
                                  tableHead={
                                    this.state.grossMarginCurrencyColumns
                                  }
                                ...
                                <div
                                  ...
                                  style={{ marginTop: 20 }}
                                >
                                  * -ve sign means Home Currency weakens. +ve
                                  sign means Home Currency strengthens.
                                </div>
                              </CardBody>
                            </>
                          ) : null}
