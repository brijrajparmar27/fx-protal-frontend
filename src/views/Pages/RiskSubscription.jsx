...
import DemoSubscriptionModal from "views/Components/RiskSubscription/DemoSubscriptionModal";
...
const RISK_ITEMS = [
  ...
  },
  {
    ...
    video: [
      {
        title: "RISK RADAR VIDEO 1",
        link:
          "https://fxguard-cms.s3.eu-west-2.amazonaws.com/cms/public/images/Risk+Radar+Video+1.mp4",
      },
      {
        title: "RISK RADAR VIDEO 2",
        link:
          "https://fxguard-cms.s3.eu-west-2.amazonaws.com/cms/public/images/Risk+Radar+Video+Part+2.mp4",
      },
    ],
  },
  ...
  {
    name: "Live Reference Price Check – Spot and Forward",
    id: "price-check",
    video: [],
  },
];
const RiskSubscription = ({ classes }) => {
  ...
  useEffect(()=>{
    console.log("user expired:- ", expiredUser);
  },[expiredUser])
    ...
    <>
      <GridContainer justify="center" style={{ textAlign: "center" }}>
        <GridItem xs={11} sm={11} md={11} lg={11}>
          ...
          {cancelledUser &&
          riskStatus.status &&
          riskStatus.status !== "INACTIVE" ? (
            <>
              <h3>{"Reactivate your plan"}</h3>
              <p style={{ color: "red" }}>
                {"Your access to the FX Risk Management Portal will cease on " +
                  formatDate(riskStatus.planExpiryDate)}
              </p>
            </>
          ) : (
            <>
              {riskStatus.freePlanUsed ? (
                <h3>Select your Plan - No Credit Card Required</h3>
              ) : (
                <h3>
                  Select your Plan – One Month Free - No Credit Card Required
                </h3>
              )}
            </>
          )}
        ...
        <GridItem
          ...
          md={11}
          lg={11}
          style={{ justifyContent: "center", marginTop: 40, marginBottom: 20 }}
        >
          {/* <Button
            size="lg"
          ...
          <span
            ...
            onClick={(event) => onContactUs(event, CONTACT_PLAN_INFO)}
          >
            Contact Us for Demo
          </span>
        </GridItem>
        ...
        >
          <h4>
            {cancelledUser ? (
              <>
                {
                  "The plan will automatically renew each month until cancelled. To avoid charges for the next month, please cancel before the renewal date on Manage Account. Also, you can always upgrade your plan (or cancel the plan) anytime by going to Manage Plan page."
                }
              </>
            ) : (
              <>
        ...
        >
          <center>
            <h3>
              <b>What you get from Risk Management Subscription</b>
            </h3>
          </center>
          <h4 id="risk-insight">
            <b>Risk Insight</b>
          ...
          <h4>
            Risk Insight gives insight into the foreign exchange (FX) risks that
            exist in your business.
          </h4>
          <h4>
            This tool helps you identify different types of FX risks in your
            business. It also allows you to quantify these FX risks.
            Furthermore, it suggests a way forward for you to mitigate and
            manage FX risks in your business.
          </h4>
          <h4 id="fx-calculator">
            <b>FX Exposure Calculator</b>
          </h4>
          <h4>
            This provides you an easy and intuitive way to look at the impact of
            FX changes on your bottom line or margins. Furthermore, it also
            provides a scenario analysis on how different level of hedging
            percentages can protect your gross margin taking in to account
            certain hedging costs that may be required for hedging.
          </h4>
          <h4 id="risk-radar">
            <b>Risk Radar</b>
          </h4>
          <h4>
            This a key tool that enables you to monitor FX risks in real time by
            inputting your exposure data and any existing hedging that you may
            done with hedge providers. It calculates the FX Risk impact, and can
            be set up to alert you beyond a specific level of FX risks. It also
            provides you “What If” scenario on a particular hedging decision
            that you may consider. Furthermore, it provides you various reports
            that may further help you in understanding your FX risks and in
            decision making.
          </h4>
          <h4 id="risk-policy">
            <b>FX Risk Policy</b>
          ...
          <h4>
            This gives you a simple generic template policy framework which when
            required you can further customise based on your own specific
            requirements.
          </h4>
          ...
          <h4>
            This covers a range of most commonly asked questions including how
            various FX exposures can be hedged using FX Forward contracts.
          </h4>
          <h4 id="hedge-accounting">
            <b>Hedge Accounting</b>
          </h4>
          <h4>
            Hedge Accounting deals with introduction of hedge accounting, type
            of hedge accounting, a tool to assess if hedge accounting may be
            applicable to your hedging situation and which type, and sample
            documentation for the hedge accounting. Accounting entries for the
            hedge accounting is also expected to be added in the near future.
          </h4>
          <h4 id="historical-rates">
            <b>Historical FX Data Download</b>
          </h4>
          <h4>
            You can get the historical FX Spot data on any chosen currency pair
            for various information requirements such as for charting, or for
            accounting. This high quality, accurate, and reliable data is
            provided by the independent provider Xignite which we bring to you
            in a very simple and easy to access manner.
          </h4>
          <h4 id="market-intelligence">
            <b>Market Intelligence</b>
          </h4>
          <h4>
            Market Intelligence is a key tool to monitor the FX market which
            helps in decision making on assessing and hedging FX exposure,
            benchmarking the hedges, and getting the required FX data for
            accounting and other reporting purposes.
          </h4>
          <h4>
            Market Intelligence has a number of components including Live
            Exchange Rates, Cross Rates, Forward Rates, Economic Calendar and
            Currency News. Both live and historical information and FX data
            including in chart forms can be obtained in most traded currency
            pairs. Furthermore, a Live Reference FX Spot and Forward Calculator
            can be used to benchmark the pricing of any hedge provider.
          </h4>
          <h4 id="price-check">
            <b>Live Reference Price Check – Spot and Forward</b>
          </h4>
          <h4>
            Want to compare what value you are getting from any FX provider on
            Spot and Forward rates? Use the Calculator to get the live, time
            stamped mid-rate for the chosen/available currency pair. The rate
            obtained from this Reference Price Check is a mid-rate obtained from
            independent provider Xignite. This is a valuable and handy tool to
            get information on the rates at which the FX market is trading at
            the time of enquiry.
          </h4>
        </GridItem>
      </GridContainer>
      {callInProgress && <CircularProgresss callInProgress={callInProgress} />}
      {showSubscriptionModal && !expiredUser && (
