...
const SignupPage = (props) => {
  ...
  const submitUser = async () => {
    ...
    const user = {
      ...
      mfaChannel: "EMAIL",
      notProspectDemoUser:
        location.state != null ? location.state.notProspectDemoUser : false,
    };
  ...
  const getPasswordHelpText = () => {
    ...
    return initial.passwordState === "error"
      ? initial.passwordErrorMsg[0]
      : helpText;
  };
  ...
  const handleClose = (modal, isSignup) => {
    ...
    if (initial.isAutoLogin) handleLoginSubmit();
    setState({ ...x });
  };
  const handleLoginSubmit = async () => {
    ...
    const response = await axios.post(
      endpoint.BASE_URL_STAGING_AXIOS + endpoint.LOGIN_OAUTH,
      data
    );
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <h3 className={cx(classes.modalTitle, classes.otpModalTitle)}>
                    Signup
                  </h3>
              ...
              >
                ...
                >
                  <IconButton
                    ...
                    className={classes.closeButton}
                    onClick={() =>
                      handleClose("signUpModal", initial.isAutoLogin)
                    }
                  >
                    <CloseIcon />
                  </IconButton>
                    ...
                    <GridContainer justify="center">
                        ...
                        <GridContainer spacing={1} alignItems="center">
                          ...
                          >
                            <CustomInput
                              ...
                              helpText={
                                initial.firstNameState === "error" &&
                                initial.firstNameErrorMsg[0]
                              }
                          ...
                          >
                            <CustomInput
                              ...
                              helpText={
                                initial.lastNameState === "error" &&
                                initial.lastNameErrorMsg[0]
                              }
                              labelText="Last Name*"
                              id="sp_lastName"
                              formControlProps={{
                        ...
                        <GridContainer spacing={1} alignItems="center">
                          ...
                          >
                            <CustomInput
                              ...
                              helpText={
                                initial.emailState === "error" &&
                                initial.emailErrorMsg[0]
                              }
                        ...
                        <GridContainer spacing={1} alignItems="center">
                          ...
                          >
                            ...
                            <CustomInput
                              ...
                              error={initial.phoneNumberState === "error"}
                              helpText={
                                initial.phoneNumberState === "error" &&
                                initial.phoneNumberErrorMsg[0]
                              }
                              labelText="Phone Number*"
                              id="sp_phoneNumber"
                              formControlProps={{
                        ...
                        <GridContainer spacing={1} alignItems="center">
                          ...
                          >
                            <CustomInput
                              ...
                              helpText={
                                initial.companyNameState === "error" &&
                                initial.companyNameErrorMsg[0]
                              }
                      ...
                      >
                        <CustomInput
                          ...
                          helpText={
                            initial.addressState === "error" &&
                            initial.addressErrorMsg[0]
                          }
                          labelText="Address"
                          id="sp_address"
                          formControlProps={{
                        ...
                        <GridContainer>
                          <GridItem xs={12} sm={10} md={4}>
                            <CustomInput
                              ...
                              helpText={
                                initial.cityState === "error" &&
                                initial.cityErrorMsg[0]
                              }
                              labelText="City"
                              id="sp_city"
                              formControlProps={{
                          ...
                          <GridItem xs={12} sm={10} md={4}>
                            <CustomInput
                              ...
                              helpText={
                                initial.postalCodeState === "error" &&
                                initial.postalCodeErrorMsg[0]
                              }
                              ...
                              >
                                <CustomInput
                                  ...
                                  formControlProps={{
                                    ...
                                    onChange: (event) => {
                                      if (
                                        !initial.passwordConfirmationPristine
                                      ) {
                                        setState({
      ...
      >
        ...
        >
          <h4 className={classes.modalTitle}>
            {initial.noticeModalErrMsg === "" ? "Success" : "Error"}
          </h4>
        </DialogTitle>
        <DialogContent
        ...
        >
          <Button
            onClick={() => handleClose("noticeModal", initial.isAutoLogin)}
            color="info"
            round
          >
            OK
